...
<div class="page-wrapper">
    ...
    <!-- End Main Header -->
     ...
     <!--Page Title-->
    <section class="page-banner" style="background-image:url(images/main-slider/contact-us-banner.jpg);">
        <div class="auto-container">
            ...
            <div class="row">
                ...
                <div class="form-column col-lg-12 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="sec-title">
                            <span class="title">CAREER GROWTH AT Acme Sujan Chemicals</span>
                          
                            <div class="text">We are always on the lookout for talented professionals to join our growing team. If you are committed, ambitious and looking for a long term career, then send your CV in full confidentiality to <a href="mailto:acmesujan@gmail.com">acmesujan@gmail.com</a> </div>
                        </div>
                        ...
                        <!-- Contact Form -->
                         <div class="sec-title">
                            <span class="title">Apply Now</span>
                             ...
                             <div class="text">We have job openings at all levels and for various disciplines. Do not hesitate to get in touch with us!  </div>
                        </div>
                        <div class="contact-form style-two">
                            <div class="form-inner">
                                <!--Comment Form-->
                                <form method="post" action="http://t.commonsupport.com/industar/sendemail.php" id="contact-form">
