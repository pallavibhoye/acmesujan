...
<div class="page-wrapper">
    ...
    <div class="container" >
         <div class="">
                            <h2 class="title1">Parabens (p-Hydroxy Benzoic acid esters)</h2>
        ...
        <div class="product-table">
            <table class="table table-hover table-bordered table-striped">
                ...
                <tr>
                    <td></td>
                    <td><a href="products.html">Methyl Paraben</a> </td>
                    <td></td>
                    <td></td>
                 ...
                 <tr>
                    <td></td>
                    <td><a href="">Methyl Paraben Sodium Salt</a></td>
                    <td></td>
                    <td></td>
                </tr>
                 <tr>
                    <td></td>
                    <td><a href="">Ethyl Paraben</a></td>                    
                    <td></td>
                    <td></td>
                </tr>
                 <tr>
                    <td></td>
                    <td><a href="">Propyl Paraben</a></td>                    
                    <td></td>
                    <td></td>
                </tr>
                 <tr>
                    <td></td>
                    <td><a href="">Propyl Paraben Sodium Salt</a></td>                   
                    <td></td>
                    <td></td>
                </tr>
                 <tr>
                    <td></td>
                    <td><a href="">Butyl Paraben</a></td>
                    <td></td>
                    <td></td>
                 ...
                 <tr>
                    <td></td>
                    <td><a href="">Butyl Parabens Sodium Salt</a></td>
                    <td></td>
                    <td></td>
