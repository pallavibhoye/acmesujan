...
<link href="<?php echo base_url() ?>assets/css/fontawesome-all.css" rel="stylesheet" type="text/css">
 ...
 <link href="<?php echo base_url() ?>assets/css/line-awesome.css" rel="stylesheet" type="text/css">
 <link href="<?php echo base_url() ?>assets/css/flaticon.css" rel="stylesheet" type="text/css">
 <link href="<?php echo base_url() ?>assets/css/owl.css" rel="stylesheet" type="text/css">
...
<link href="<?php echo base_url() ?>assets/css/responsive.css" rel="stylesheet">
  <link href="<?php echo base_url() ?>assets/hover/css/hover.css" rel="stylesheet" media="all">
...
<div class="contact-main">
    ...
    <header class="main-header">
            ...
            <div class="inner-container">
                <div class="auto-container clearfix">
                    ...
                    <div class="logo-outer">
                        <div class="logo"><a href=""><img src="<?php echo base_url() ?>assets/images/logo.png" alt=""> </a>
                                ...
                                <ul class="dropdown-menu pull-right search-panel show" aria-labelledby="dropdownMenu3">
                                    <li class="panel-outer">
                                        <div class="form-container">
                                            <form method="post" action="http://t.commonsupport.com/industar/index">
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
            	<div class="nav-logo"><a href=""><img src="<?php echo base_url() ?>assets/images/nav-logo.png" alt="" title=""></a></div>
